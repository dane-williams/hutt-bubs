...
import { FaRestroom, FaChild, FaBiking, FaParking, FaBabyCarriage, FaSkating } from 'react-icons/fa'
    ...
    <>
      ...
      <div className='parks-page'>
        <div className='print_before'>
          <div>
            <h2>Avalon</h2><FaRestroom />&nbsp;<FaChild />&nbsp;<FaBiking />&nbsp;<FaParking />&nbsp;<FaBabyCarriage />&nbsp;<FaSkating />
        ...
        <div className='print_after'>
          <div>
            <h2>Parkay Play Park</h2><div className='icons'><FaRestroom />&nbsp;<FaChild />&nbsp;<FaParking />&nbsp;<FaBabyCarriage /></div>
        ...
        <div className='print_before'>
          <div>
            <h2>Maidstone Park</h2><FaRestroom />&nbsp;<FaChild />&nbsp;<FaBiking />&nbsp;<FaParking />&nbsp;<FaBabyCarriage />&nbsp;<FaSkating />
        ...
        <div className='print_after'>
          ...
          <div className='pic-div'><img className='parks' src='/images/High Sinclair Park Wainui.jpeg'/>wehhweerhweerhwerhwher</div>
        </div>
